...
const dict: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    'home.help': 'Aide',
    'home.become_driver': 'Devenez chauffeur TamCar',
    ...
    'commande.choose_category': 'Choisissez votre catégorie',
    'commande.available': 'chauffeur',
    ...
    'commande.out_of_zone_pickup': 'Votre point de départ est hors zone.',
    ...
    'ride.driver_on_way': 'Votre chauffeur arrive.',
    'ride.driver_arrived': 'Rejoignez-le au point de départ.',
    ...
    'ride.searching_near': 'On cherche un chauffeur près de vous…',
    ...
    'alternatives.no_available': 'Aucun {cat} disponible pour l\'instant. Choisissez une alternative pour partir plus vite :',
    ...
    'rating.your_note_unlocks': 'Votre note libère l\'écran d\'accueil.',
    ...
    'cat.essentiel.tagline': 'Voiture basique, fonctionnelle',
    'cat.essentiel.climate': 'Sans climatiseur',
    'cat.confort.tagline': 'Voiture confortable, bien entretenue',
    'cat.confort.climate': 'Climatiseur inclus',
    'cat.confort.badge': 'Best-seller',
    'cat.premium.tagline': 'Voiture de prestige, confort premium',
    'cat.premium.climate': 'Climatiseur inclus',
    // Cancel reasons
    ...
    'history.subtitle': 'Vos {n} dernières courses.',
    ...
    'refer.your_code': 'Votre code parrain',
    'refer.reward_line': 'Partagez votre code. Dès son 1er trajet complété, vous recevez 500 F chacun.',
    ...
    'error.not_your_ride': 'Ce n\'est pas votre course',
  ...
  en: {
    ...
    'cat.essentiel.tagline': 'Basic, functional car',
    'cat.essentiel.climate': 'No AC',
    'cat.confort.tagline': 'Comfortable, well-maintained car',
    'cat.confort.climate': 'AC included',
    'cat.confort.badge': 'Best-seller',
    'cat.premium.tagline': 'Prestige car, premium comfort',
    'cat.premium.climate': 'AC included',
