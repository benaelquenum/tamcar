-- ============================================================
-- Fix : ma migration v5 (20260716270000) référençait public.category_pricing_tiers
-- qui n'existe pas — la vraie table est public.pricing_tiers.
-- On recrée compute_price avec le bon nom de table.
-- ============================================================
