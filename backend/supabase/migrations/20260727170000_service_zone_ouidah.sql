...
-- Ouidah → Pahou → Cotonou → Porto-Novo se chevauche d'un bout à
-- l'autre → corridor continu, sans trou de couverture.
--
...
comment on function public._is_within_service_zone is
  'Zone de service : 15 km autour de Ouidah (2.085, 6.363), Pahou (2.200, 6.383), Cotonou (2.435, 6.365) et Porto-Novo (2.605, 6.497). Les cercles se chevauchent en chaîne → corridor Ouidah–Cotonou–Porto-Novo couvert en continu.';
